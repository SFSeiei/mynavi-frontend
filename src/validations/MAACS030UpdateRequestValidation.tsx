/**
 * MAACS030UpdateRequest validation
 */
...
export default yup.object().shape({
  ...
  // 企業担当者：担当者名カナ_就職担当者
  clientStaffNameFuriganaEmployment: yup
    .string()
    .max(100, validationMessageSet.maxLength)
    .test('isFullWidthKana', validationMessageSet.fullWidthKana, (value: any) => miscRegexSet.fullWidthKana.test(value)),

  // 企業担当者：メールアドレス_就職担当者
  clientStaffEmailEmployment: yup
    .string()
    .required(validationMessageSet.required)
  ...
  // 企業担当者：担当者名カナ_転職担当者
  clientStaffNameFuriganaJobChange: yup
    .string()
    .max(100, validationMessageSet.maxLength)
    .test('isFullWidthKana', validationMessageSet.fullWidthKana, (value: any) => miscRegexSet.fullWidthKana.test(value)),

  // 企業担当者：メールアドレス_転職担当者
  clientStaffEmailJobChange: yup
    .string()
    .required(validationMessageSet.required)
    .max(256, validationMessageSet.maxLength)
    .email(validationMessageSet.email),
  ...
  clientStaffNameFuriganaMagi: yup
    .string()
    .max(100, validationMessageSet.maxLength)
    .test('isFullWidthKana', validationMessageSet.fullWidthKana, (value: any) => miscRegexSet.fullWidthKana.test(value)),
